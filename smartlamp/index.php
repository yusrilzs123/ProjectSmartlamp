        ...
        <div class="inner-wrapper mt-auto mb-auto container">
          <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12 mt-auto mb-auto mr-3">
                <h1 class="welcome-heading display-4 text-white">Let's Start SmartLamp!</h1>
                <p class="text-muted">Makes it easy to adjust the lights from anywhere !</p>
                <a href="link-lampu/controllamp.php" class="btn btn-lg btn-success btn-pill align-self-center"><i class="fa fa-lightbulb-o mr-3" aria-hidden="true"></i>ControlLamp</a>
            </div>
